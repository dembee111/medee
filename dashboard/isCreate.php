    ...
    <section class="content">
                  ...
                  <div class="box-body">
                      <div class="row">
                              ...
                              <div class="form-group">
                                   <label>Регистр <span class="text-red">*</span> </label>
                    								 <div class="input-group">
                    									           <input type="text" readonly  id="register_number" name="register_number" class="form-control" value="<?php echo Session::get('register_number'); ?>" maxlength="20">
                          ...
                          <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <input type="text" readonly  name="obog" id="obog" value="<?php echo Session::get('obog'); ?>" class="form-control" placeholder="Овог" maxlength="30">
                                  <span class="text-danger"></span>
                              </div>
                              <!-- /.form-group -->
                          </div>
                          ...
                          <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <input type="text" readonly  name="ner" id="ner" value="<?php echo Session::get('ner'); ?>" class="form-control" placeholder="Нэр" maxlength="30">
                                  <span class="text-danger"></span>
                              </div>
                              <!-- /.form-group -->
                          </div>
                          ...
                          <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <input type="text" readonly  name="dugaar" id="dugaar" value="<?php echo Session::get('dugaar'); ?>" class="form-control" placeholder="Дугаар" maxlength="8" >
                                  <span class="text-danger"></span>
                              </div>
                              <!-- /.form-group -->
                          </div>
                          ...
                          <div class="col-md-2">
                              <div class="form-group">
                                  ...
                                  <input type="text" id="skills" name="nemelt_utas" value="<?php echo Session::get('nemelt_utas'); ?>" class="form-control findphone ui-autocomplete-input" placeholder="Утас" maxlength="40" autocomplete="off">
                                  <span class="text-danger"></span>
                              </div>
                              <!-- /.form-group -->
                          </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  <div class="input-group">
                                      <input type="text" name="hayg" class="form-control findaddress ui-autocomplete-input" placeholder="Хаяг" maxlength="150" autocomplete="off"><span class="input-group-addon">150</span></div>
                              </div>
                          </div>
                          <!-- /.col -->
                         <div class="col-md-3">
          ...
          <div class="col-md-7">
              <div class="row">
                ...
                <select class="form-control bignumber" name="honog_id"  id="getdayid" fid="79" title="Хоног сонгох">
